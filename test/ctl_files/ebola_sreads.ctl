      ...
      workdir = test/workdirs/ebola_sreads # directory where contigs/reads files are located and output is stored
    ...
    reference = 1  # 0:pick a random reference; 1:use given reference; 2: use ANI based reference
      ...
      project = ebola_single_reads  # main alignment file name
