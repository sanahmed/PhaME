       refdir = ../data/flu_ref  # directory where reference files are located
      workdir = ../workdirs/t11_flu # directory where contigs/reads files are located and output is stored
    ...
    PosSelect = 0  # 0:No; 1:use PAML; 2:use HyPhy; 3:use both
      ...
      threads = 2  # Number of threads to use
       ...
       cutoff = 0.3  # Linear alignment (LA) coverage against reference - ignores SNPs from organism that have lower cutoff.
