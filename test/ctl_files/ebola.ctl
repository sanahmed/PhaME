       refdir = test/ebola_ref  # directory where reference files are located
      workdir = test/ebola_workdir # directory where contigs/reads files are located and output is stored
