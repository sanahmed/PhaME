...
then
	...
	runPhaME test/ctl_files/t4_ebola_complete.ctl
...
if [[ $1 -eq 6 ]] || [[ -z $1 ]];then
	...
	runPhaME test/ctl_files/t6_ebola_cmp_sreads.ctl
...
then
	...
	runPhaME test/ctl_files/t7_ebola_cmp_preads.ctl
...
then
	...
	runPhaME test/ctl_files/t8_ebola_ctg_sreads.ctl
...
then
	...
	runPhaME test/ctl_files/t9_ebola_ctg_preads.ctl
...
then
	...
	runPhaME test/ctl_files/t10A_error_message.ctl > test/workdirs/t10_error_messages/A.error
	runPhaME test/ctl_files/t10B_error_message.ctl > test/workdirs/t10_error_messages/B.error
...
then
	...
	runPhaME test/ctl_files/t11_flu_test_coverage_threshold.ctl
...
then
	...
	runPhaME test/ctl_files/t14_secondtime.ctl
